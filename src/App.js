            ...
            <div>
              ...
              <div className="d-flex align-items-center justify-content-around">
                ...
                <label className="container">
                  <input
                    type="checkbox"
                    onChange={(e) => setStatusValue("in_progress")}
                  />
                  <span className="checkmark">Reinburse</span>
                </label>
              </div>
              <label className="container mt-4">
                <input
                  type="checkbox"
                  onChange={(e) => setStatusValue("reinburse")}
                />
                <span className="checkmark">In progress</span>
              </label>
            </div>
          </div>
        </div>
